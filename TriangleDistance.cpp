...
Vector3D TriangleDistance::Project(Vector3D point, LineSegment3D lineSegment)
{
...
Vector3D TriangleDistance::Project(Vector3D point, Triangle3D triangle)
{
	LineSegment3D linePerpendicularToTriangle;
	linePerpendicularToTriangle.point1 = triangle.point1 + triangle.computeNormal();
...
bool TriangleDistance::AreParallel(LineSegment3D lineSegment, Triangle3D triangle)
{
	return vector3DUtils.dot(lineSegment.vector(), triangle.computeNormal()) == 0;
}

float TriangleDistance::lenSquared(Vector3D vector)
{
	return pow(vector3DUtils.length(vector), 2);
}

LineSegment3D TriangleDistance::GetShortest(vector <LineSegment3D> list)
{
...
bool TriangleDistance::AreIncident(Vector3D point, LineSegment3D lineSegment)
{
...
bool TriangleDistance::AreIncident(Vector3D point, Triangle3D triangle)
{
...
LineSegment3D TriangleDistance::ShortestLineSegmentBetween(Vector3D point1, Vector3D point2)
{
	LineSegment3D ret;
	ret.point1 = point1;
	ret.point2 = point2;
...
LineSegment3D TriangleDistance::ShortestLineSegmentBetween(Vector3D point, LineSegment3D lineSegment)
{
...
bool TriangleDistance::AreParallel(LineSegment3D lineSegment1, LineSegment3D lineSegment2)
{
...
LineSegment3D TriangleDistance::ShortestLineSegmentBetween(LineSegment3D lineSegment1, LineSegment3D lineSegment2)
{
...
LineSegment3D TriangleDistance::ShortestLineSegmentBetween(Vector3D point, Triangle3D triangle)
{
...
LineSegment3D TriangleDistance::ShortestLineSegmentBetween(LineSegment3D lineSegment, Triangle3D triangle)
{
	...
	Vector3D triangleNormal = triangle.computeNormal();
...
LineSegment3D TriangleDistance::triTriIntersectPoints(Triangle3D triangle1, Triangle3D triangle2)
{
